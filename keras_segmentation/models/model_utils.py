...
# modified from get_segmentation_model so models can have input_height and input_width
# diecriminators (and therefore gans) just have one output, so output_height and output_width irrelevant
def add_input_dims(keras_model):

    img_input = keras_model.inputs
    o = keras_model.outputs
