...
def get_resnet50_encoder(input_height=224,  input_width=224, input_chan=3,
                         pretrained='imagenet',
    ...
    # assert input_height % 32 == 0  # why are these assertions here? Seems to work fine without passing them
