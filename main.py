...
train_all(gen_model=gen_segnet, gen_model_name='segnet', d_model=disc_segnet_stacked, gan_model=gan_segnet_stacked, reg_or_stacked='stacked')
print("finished train_all")
